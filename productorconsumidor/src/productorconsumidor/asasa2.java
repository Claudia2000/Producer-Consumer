...
public class asasa2 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 402, 480);
		...
		label1.setBounds(28, 360, 89, 44);
		frame.getContentPane().add(label1);
		
		Label label2 = new Label("time desp");
		label2.setBounds(147, 360, 89, 44);
		frame.getContentPane().add(label2);
		
		Label label3 = new Label("time desp");
		label3.setBounds(262, 360, 84, 44);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Thread prodThread = new Thread(new Producer(sharedQueue,0,progressBar,textArea,label1));
				prodThread.start();
